...
```
 2. dzdo Access  
The agent user must have **dzdo** privileges to execute Python with elevated permissions.

 3. Linux Environment  
This script is designed to run inside a **Linux build agent** or server environment.
